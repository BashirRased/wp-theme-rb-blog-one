	...
	<div class="rb-home-post-meta">
		...
		<div class="rb-meta-date">
			...
			<span class="rb-post-meta-text">
				...
				?>
				<a href="<?php echo esc_attr( get_day_link( $rb_archive_year, $rb_archive_month, $rb_archive_day) ); ?>"><?php echo get_the_date('j F Y'); ?></a>			
			</span>
		</div>
		...
		?>
			<div class="rb-meta-post-edit">
				...
				<span class="rb-post-meta-text"><?php echo esc_html( edit_post_link('Edit This Post') ); ?></span>			
			</div>
		<?php
			}
		?>		
