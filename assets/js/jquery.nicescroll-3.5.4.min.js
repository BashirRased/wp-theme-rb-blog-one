                ...
                if (!a.ispage || (!d.cantouch && !d.isieold && !d.isie9mobile)) {
                    ...
                    !1 === a.opt.autohidemode
                        ...
                        ? ((a.autohidedom = e().add(a.rail)),
                          ...
                          a.railh && d.isie8 && (a.autohidedom = a.autohidedom.add(a.cursorh)))
                    ...
                    if (d.isie9mobile)
                            ...
                            a.ontouchmove = function (c, b) {
                                ...
                                if (a.rail.drag && 2 == a.rail.drag.pt) {
                                    ...
                                    a.ishwscroll && a.opt.bouncescroll
                                        ? 0 > g
                                            ? (g = Math.round(g / 2))
                                            : g > a.page.maxh && (g = a.page.maxh + Math.round((g - a.page.maxh) / 2))
                                        : (0 > g && (h = g = 0), g > a.page.maxh && ((g = a.page.maxh), (h = 0)));
                                    if (a.railh && a.railh.scrollable) {
                                        ...
                                        a.ishwscroll && a.opt.bouncescroll
                                            ...
                                            : (0 > l && (k = l = 0), l > a.page.maxw && ((l = a.page.maxw), (k = 0)));
                                    }
                                    f = !1;
                        ...
                        a.opt.enablemousewheel &&
                            (a.isiframe || a.bind(d.isie && a.ispage ? document : a.win, "mousewheel", a.onmousewheel), a.bind(a.rail, "mousewheel", a.onmousewheel), a.railh && a.bind(a.railh, "mousewheel", a.onmousewheelhr));
                        !a.ispage &&
                            !d.cantouch &&
